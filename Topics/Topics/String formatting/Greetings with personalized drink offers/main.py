...
def create_greeting(friend_name, favorite_drink):
    ...
    return "Hello {name}, I hope you are having a wonderful day! Would you like a glass of {drink}?".format(name=friend_name.capitalize(), drink=favorite_drink.capitalize())
